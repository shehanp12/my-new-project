 ...
 * https://www.webiny.com/docs/how-to-guides/webiny-cli/scaffolding/extend-graphql-api#typedefsunittestts
 */

describe("GraphQL type definitions test", () => {
    test("ensure type definitions include CarAdmin type", async () => {
        expect(typeDefs.includes("type CarAdmin")).toBe(true);
    });
});
